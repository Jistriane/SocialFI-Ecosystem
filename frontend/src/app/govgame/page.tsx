...
export default function GovGamePage() {
  ...
  const [showActiveProposalsModal, setShowActiveProposalsModal] =
    useState(false)
    ...
    const loadProposals = async () => {
      ...
      try {
        ...
        const formattedProposals: Proposal[] =
          contractProposals?.map((proposal: any) => ({
        ...
        if (address) {
          const userProposals = formattedProposals.filter(
  ...
  const handleVote = async (proposalId: number, support: boolean) => {
    ...
    try {
      ...
      toast({
        title: 'Sucesso!',
        description: `Voto registrado com sucesso! Você votou ${
          support ? 'A FAVOR' : 'CONTRA'
        } da proposta.`,
      })
          ...
          {!isConnected && (
            <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6 text-center">
              ...
              <p className="text-slate-300 mb-4">
                Para participar da governança, você precisa conectar sua
                carteira primeiro.
              </p>
                        ...
                        <div className="flex justify-between items-start mb-3">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 text-sm text-slate-500">
                              <span>
                                Por: {proposal.proposer.slice(0, 10)}...
                              </span>
